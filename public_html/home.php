...
<body data-spy="scroll" data-target=".navbar" data-offset="40">
    ...
    <nav class="custom-navbar" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="logo" href="#"><img src="./assets/imgs/logo.png" class="img-logo" alt="Sunitronics Technology" ></a>         
            <ul class="nav">
                <li class="item">
    ...
    <header id="home" class="header">
        ...
        <div class="header-content container">
            <h1 class="header-title">
                <span class="up">Salut!</span>
                <span class="down">Je suis Jeremy</span>
            </h1>
            <p class="header-subtitle">DEVELOPPEUR FULL-STACK</p>            

            <a href="#portfolio" class="btn btn-primary">Coups d'oeil sur mes réalisations</a>
        </div>              
        ...
        <div class="container text-center">
            ...
            <div class="about">
                ...
                <div class="about-caption">
                    ...
                    <p>
                        Attiré par l'informatique et le commerce depuis tout jeune, j'ai voulu transformer cette passion en mon métier.
                        <br>
                        La programmation est un plaisir quotidien pour moi, pouvoir l'exercer et aider des personnes à concrétiser leurs rêves en le faisant est un réel bonheur.
                        <br>
    ...
    <section class="section" id="service">
        <div class="container text-center">
            <p class="section-subtitle">Concrètement tu fais quoi ?</p>
   ...
   <!-- portfolio section -->
    <section class="section" id="portfolio">
        <div class="container text-center">
            <p class="section-subtitle">Aurais-tu réalisé des projets ?</p>
            <h6 class="section-title mb-6">Ils m'ont fait confiance</h6>
            <ul class="nav nav-tabs">
                <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="#all">Tout</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#pro">Pro</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#perso">Perso</a>
                </li>
            </ul>
            <!-- row -->
            ...
            <form action="https://mailadmin.alwaysdata.net/mail.php" class="contact-form col-md-10 col-lg-8 m-auto">
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 mt-3">
                        <input type="submit" value="Envoyer" class="btn btn-outline-primary rounded">                  
                    </div>
                </div>  
    ...
    <div class="container">
        <footer class="footer">       
            <p class="mb-0">Copyright <script>document.write(new Date().getFullYear())</script> &copy; Sunitronics</p>
